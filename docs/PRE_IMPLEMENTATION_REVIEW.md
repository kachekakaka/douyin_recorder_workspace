...
- DOCX/PDF 是发布快照；`architecture-baseline-v2.0.md` 是便于 Git diff 和 PR 审查的文本基线。
...
.github/workflows/ci.yml（最迟 P0 第一个 PR）
```

### 7. API 小修订

架构文档中的任务接口按以下形式实现，避免路径歧义：
...
- 仓库已创建并完成初始 push；
- 架构 DOCX、PDF、Markdown 和本审查文件均在 GitHub；
- 新窗口具有 GitHub 写权限；
